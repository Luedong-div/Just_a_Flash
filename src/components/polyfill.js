...
console.log(encryptConfig({ memoryZhu: [3, 13], dreamDian: 1, jiangFu: [2, 7] }, "shaonian"));
// console.log(decryptAndVerifyConfig("eyJtZW1vcnlaaHUiOlsxLDEwXSwiZHJlYW1EaWFuIjoxLCJqaWFuZ0Z1IjpbMSw1XX0=|3cb366db", "shaonian"));
